...
<form action="pw_find.do" method="get">
  <div align="center">
 <p><font color="#3B83BD" size="5">1</font>아이디</p><input type="text"  name="member_id"  id="id" placeholder="아이디를 입력해주세요" required class="outbox" style="height:50px; width:430px; "></input>
